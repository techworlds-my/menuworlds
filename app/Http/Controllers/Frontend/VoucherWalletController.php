...
class VoucherWalletController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.voucherWallets.index', compact('voucherWallets'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.voucherWallets.create', compact('usernames', 'vouchers'));
    }
    ...
    public function store(StoreVoucherWalletRequest $request)
    {
        ...
        return redirect()->route('frontend.voucher-wallets.index');
    }
    ...
    public function edit(VoucherWallet $voucherWallet)
    {
        ...
        return view('frontend.voucherWallets.edit', compact('usernames', 'vouchers', 'voucherWallet'));
    }
    ...
    public function show(VoucherWallet $voucherWallet)
    {
        ...
        return view('frontend.voucherWallets.show', compact('voucherWallet'));
    }
