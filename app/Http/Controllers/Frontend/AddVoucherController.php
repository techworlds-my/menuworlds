...
class AddVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.addVouchers.index', compact('addVouchers', 'item_managements', 'merchant_managements', 'item_categories', 'item_sub_categories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.addVouchers.create', compact('select_items', 'merchants', 'categories', 'sub_categories'));
    }
    ...
    public function edit(AddVoucher $addVoucher)
    {
        ...
        return view('frontend.addVouchers.edit', compact('select_items', 'merchants', 'categories', 'sub_categories', 'addVoucher'));
    }
