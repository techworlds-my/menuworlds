...
class SeatsLogController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.seatsLogs.index', compact('seatsLogs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.seatsLogs.create', compact('orders'));
    }
    ...
    public function store(StoreSeatsLogRequest $request)
    {
        ...
        return redirect()->route('frontend.seats-logs.index');
    }
    ...
    public function edit(SeatsLog $seatsLog)
    {
        ...
        return view('frontend.seatsLogs.edit', compact('orders', 'seatsLog'));
    }
    ...
    public function show(SeatsLog $seatsLog)
    {
        ...
        return view('frontend.seatsLogs.show', compact('seatsLog'));
    }
