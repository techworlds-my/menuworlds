...
class VoucherCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.voucherCategories.index', compact('voucherCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.voucherCategories.create');
    }
    ...
    public function store(StoreVoucherCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.voucher-categories.index');
    }
    ...
    public function edit(VoucherCategory $voucherCategory)
    {
        ...
        return view('frontend.voucherCategories.edit', compact('voucherCategory'));
    }
    ...
    public function show(VoucherCategory $voucherCategory)
    {
        ...
        return view('frontend.voucherCategories.show', compact('voucherCategory'));
    }
