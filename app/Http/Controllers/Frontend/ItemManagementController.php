...
class ItemManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.itemManagements.index', compact('itemManagements', 'item_sub_cateogries'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.itemManagements.create', compact('sub_cateogries'));
    }
    ...
    public function edit(ItemManagement $itemManagement)
    {
        ...
        return view('frontend.itemManagements.edit', compact('sub_cateogries', 'itemManagement'));
    }
