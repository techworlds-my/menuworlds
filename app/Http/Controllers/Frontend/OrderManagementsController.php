...
class OrderManagementsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.orderManagements.create', compact('merchants', 'payment_methods', 'statuses', 'vouchers'));
    }
    ...
    public function edit(OrderManagement $orderManagement)
    {
        ...
        return view('frontend.orderManagements.edit', compact('merchants', 'payment_methods', 'statuses', 'vouchers', 'orderManagement'));
    }
