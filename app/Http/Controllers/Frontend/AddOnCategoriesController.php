...
class AddOnCategoriesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.addOnCategories.index', compact('addOnCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.addOnCategories.create', compact('created_bies'));
    }
    ...
    public function store(StoreAddOnCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.add-on-categories.index');
    }
    ...
    public function edit(AddOnCategory $addOnCategory)
    {
        ...
        return view('frontend.addOnCategories.edit', compact('created_bies', 'addOnCategory'));
    }
    ...
    public function show(AddOnCategory $addOnCategory)
    {
        ...
        return view('frontend.addOnCategories.show', compact('addOnCategory'));
    }
