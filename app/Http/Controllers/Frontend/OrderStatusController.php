...
class OrderStatusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.orderStatuses.index', compact('orderStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.orderStatuses.create');
    }
    ...
    public function store(StoreOrderStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.order-statuses.index');
    }
    ...
    public function edit(OrderStatus $orderStatus)
    {
        ...
        return view('frontend.orderStatuses.edit', compact('orderStatus'));
    }
    ...
    public function show(OrderStatus $orderStatus)
    {
        ...
        return view('frontend.orderStatuses.show', compact('orderStatus'));
    }
