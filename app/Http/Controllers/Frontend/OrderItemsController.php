...
class OrderItemsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.orderItems.index', compact('orderItems', 'item_managements', 'order_managements'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.orderItems.create', compact('items', 'orders'));
    }
    ...
    public function edit(OrderItem $orderItem)
    {
        ...
        return view('frontend.orderItems.edit', compact('items', 'orders', 'orderItem'));
    }
