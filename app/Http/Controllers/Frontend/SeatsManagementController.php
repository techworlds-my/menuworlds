...
class SeatsManagementController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.seatsManagements.index', compact('seatsManagements'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.seatsManagements.create', compact('orders'));
    }
    ...
    public function store(StoreSeatsManagementRequest $request)
    {
        ...
        return redirect()->route('frontend.seats-managements.index');
    }
    ...
    public function edit(SeatsManagement $seatsManagement)
    {
        ...
        return view('frontend.seatsManagements.edit', compact('orders', 'seatsManagement'));
    }
    ...
    public function show(SeatsManagement $seatsManagement)
    {
        ...
        return view('frontend.seatsManagements.show', compact('seatsManagement'));
    }
