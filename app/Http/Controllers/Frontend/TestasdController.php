...
class TestasdController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.testasds.index', compact('testasds'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.testasds.create');
    }
    ...
    public function store(StoreTestasdRequest $request)
    {
        ...
        return redirect()->route('frontend.testasds.index');
    }
    ...
    public function edit(Testasd $testasd)
    {
        ...
        return view('frontend.testasds.edit', compact('testasd'));
    }
    ...
    public function show(Testasd $testasd)
    {
        ...
        return view('frontend.testasds.show', compact('testasd'));
    }
