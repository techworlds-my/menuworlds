...
class VoucherReedemController extends Controller
{
    public function index()
    {
        ...
        return view('admin.voucherReedems.index', compact('voucherReedems'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.voucherReedems.create', compact('voucher_codes', 'usernames', 'merchants'));
    }
    ...
    public function store(StoreVoucherReedemRequest $request)
    {
        ...
        return redirect()->route('admin.voucher-reedems.index');
    }
    ...
    public function edit(VoucherReedem $voucherReedem)
    {
        ...
        return view('admin.voucherReedems.edit', compact('voucher_codes', 'usernames', 'merchants', 'voucherReedem'));
    }
    ...
    public function show(VoucherReedem $voucherReedem)
    {
        ...
        return view('admin.voucherReedems.show', compact('voucherReedem'));
    }
