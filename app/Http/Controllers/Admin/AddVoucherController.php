...
class AddVoucherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.addVouchers.index', compact('addVouchers', 'item_managements', 'item_catrgories', 'item_sub_cateogries', 'merchant_managements'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.addVouchers.create', compact('select_items', 'selected_categories', 'selected_sub_categories', 'merchants'));
    }
    ...
    public function edit(AddVoucher $addVoucher)
    {
        ...
        return view('admin.addVouchers.edit', compact('select_items', 'selected_categories', 'selected_sub_categories', 'merchants', 'addVoucher'));
    }
