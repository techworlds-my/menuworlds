...
class AddVoucherController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.addVouchers.create', compact('select_items', 'selected_categories', 'selected_sub_categories'));
    }
    ...
    public function edit(AddVoucher $addVoucher)
    {
        ...
        return view('admin.addVouchers.edit', compact('select_items', 'selected_categories', 'selected_sub_categories', 'addVoucher'));
    }
