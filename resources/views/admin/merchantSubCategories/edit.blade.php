        ...
        <form method="POST" action="{{ route("admin.merchant-sub-categories.update", [$merchantSubCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_enable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_enable" id="in_enable" value="1" {{ $merchantSubCategory->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent') ? 'is-invalid' : '' }}" type="text" name="parent" id="parent" value="{{ old('parent', $merchantSubCategory->parent) }}" required>
