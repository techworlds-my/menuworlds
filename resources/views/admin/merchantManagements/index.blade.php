                        ...
                        <tr data-entry-id="{{ $merchantManagement->id }}">
                            ...
                            <td>
                                @can('merchant_management_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.merchant-managements.show', $merchantManagement->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('merchant_management_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.merchant-managements.edit', $merchantManagement->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('merchant_management_delete')
                                    <form action="{{ route('admin.merchant-managements.destroy', $merchantManagement->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
