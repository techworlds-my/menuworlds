    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-items.update", [$orderItem->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('add_on_price') ? 'is-invalid' : '' }}" type="number" name="add_on_price" id="add_on_price" value="{{ old('add_on_price', $orderItem->add_on_price) }}" step="0.01">
