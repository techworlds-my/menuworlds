...
@can('merchant_category_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.merchant-categories.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-MerchantCategory">
            <thead>
                <tr>
                    <th width="10">
...
@can('merchant_category_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.merchant-categories.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.merchant-categories.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-MerchantCategory').DataTable(dtOverrideGlobals);
