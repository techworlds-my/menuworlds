        ...
        <form method="POST" action="{{ route("admin.merchant-levels.update", [$merchantLevel->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_enable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_enable" id="in_enable" value="1" {{ $merchantLevel->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="in_enable">{{ trans('cruds.merchantLevel.fields.in_enable') }}</label>
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $merchantLevel->description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('module') ? 'is-invalid' : '' }}" type="text" name="module" id="module" value="{{ old('module', $merchantLevel->module) }}">
