...
@can('merchant_level_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.merchant-levels.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-MerchantLevel">
            <thead>
                <tr>
                    <th width="10">
...
@can('merchant_level_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.merchant-levels.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.merchant-levels.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-MerchantLevel').DataTable(dtOverrideGlobals);
