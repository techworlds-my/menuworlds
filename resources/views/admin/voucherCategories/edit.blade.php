    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.voucher-categories.update", [$voucherCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $voucherCategory->category) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_enable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_enable" id="is_enable" value="1" {{ $voucherCategory->is_enable || old('is_enable', 0) === 1 ? 'checked' : '' }}>
