                        ...
                        <tr data-entry-id="{{ $itemManagement->id }}">
                            ...
                            <td>
                                @can('item_management_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.item-managements.show', $itemManagement->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('item_management_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.item-managements.edit', $itemManagement->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('item_management_delete')
                                    <form action="{{ route('admin.item-managements.destroy', $itemManagement->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
