...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.item-managements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_price') ? 'is-invalid' : '' }}" type="text" name="sales_price" id="sales_price" value="{{ old('sales_price', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_recommended') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_recommended" id="is_recommended" value="1" {{ old('is_recommended', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_popular') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_popular" id="is_popular" value="1" {{ old('is_popular', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_new') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_new" id="is_new" value="1" {{ old('is_new', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    ...
                    <label class="form-check-label" for="is_active">{{ trans('cruds.itemManagement.fields.is_active') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_veg') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_veg" id="is_veg" value="1" {{ old('is_veg', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_veg">{{ trans('cruds.itemManagement.fields.is_veg') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_halal') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_halal" id="is_halal" value="1" {{ old('is_halal', 0) == 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_halal">{{ trans('cruds.itemManagement.fields.is_halal') }}</label>
                </div>
