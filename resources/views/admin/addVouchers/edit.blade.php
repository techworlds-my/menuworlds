...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-vouchers.update", [$addVoucher->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="voucher_code">{{ trans('cruds.addVoucher.fields.voucher_code') }}</label>
                <input class="form-control {{ $errors->has('voucher_code') ? 'is-invalid' : '' }}" type="text" name="voucher_code" id="voucher_code" value="{{ old('voucher_code', $addVoucher->voucher_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value') ? 'is-invalid' : '' }}" type="number" name="value" id="value" value="{{ old('value', $addVoucher->value) }}" step="0.01" required>
                @if($errors->has('value'))
                    <div class="invalid-feedback">
                        {{ $errors->first('value') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('redeem_point') ? 'is-invalid' : '' }}" type="number" name="redeem_point" id="redeem_point" value="{{ old('redeem_point', $addVoucher->redeem_point) }}" step="0.01">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_free_shipping') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_free_shipping" id="is_free_shipping" value="1" {{ $addVoucher->is_free_shipping || old('is_free_shipping', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_credit_purchase') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_credit_purchase" id="is_credit_purchase" value="1" {{ $addVoucher->is_credit_purchase || old('is_credit_purchase', 0) === 1 ? 'checked' : '' }}>
