    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-vouchers.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="voucher_code">{{ trans('cruds.addVoucher.fields.voucher_code') }}</label>
                            <input class="form-control" type="text" name="voucher_code" id="voucher_code" value="{{ old('voucher_code', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="redeem_point" id="redeem_point" value="{{ old('redeem_point', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_free_shipping" id="is_free_shipping" value="1" {{ old('is_free_shipping', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_credit_purchase" id="is_credit_purchase" value="1" {{ old('is_credit_purchase', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="expired_time" id="expired_time" value="{{ old('expired_time') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="select_items[]" id="select_items" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_spend" id="min_spend" value="{{ old('min_spend', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_spend" id="max_spend" value="{{ old('max_spend', '') }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="excluded_sales_item" id="excluded_sales_item" value="1" {{ old('excluded_sales_item', 0) == 1 ? 'checked' : '' }}>
                                <label for="excluded_sales_item">{{ trans('cruds.addVoucher.fields.excluded_sales_item') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="selected_categories[]" id="selected_categories" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="selected_sub_categories[]" id="selected_sub_categories" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="limit_per_user" id="limit_per_user" value="{{ old('limit_per_user', '') }}" step="1">
