                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.add-vouchers.update", [$addVoucher->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="expired_time" id="expired_time" value="{{ old('expired_time', $addVoucher->expired_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="min_spend" id="min_spend" value="{{ old('min_spend', $addVoucher->min_spend) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="max_spend" id="max_spend" value="{{ old('max_spend', $addVoucher->max_spend) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="excluded_sales_item" id="excluded_sales_item" value="1" {{ $addVoucher->excluded_sales_item || old('excluded_sales_item', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="usage_limit" id="usage_limit" value="{{ old('usage_limit', $addVoucher->usage_limit) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="limit_per_user" id="limit_per_user" value="{{ old('limit_per_user', $addVoucher->limit_per_user) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="merchant_id" id="merchant_id">
                                @foreach($merchants as $id => $merchant)
                                    <option value="{{ $id }}" {{ (old('merchant_id') ? old('merchant_id') : $addVoucher->merchant->id ?? '') == $id ? 'selected' : '' }}>{{ $merchant }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="categories[]" id="categories" multiple>
                                @foreach($categories as $id => $category)
                                    <option value="{{ $id }}" {{ (in_array($id, old('categories', [])) || $addVoucher->categories->contains($id)) ? 'selected' : '' }}>{{ $category }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="sub_categories[]" id="sub_categories" multiple>
                                @foreach($sub_categories as $id => $sub_category)
                                    <option value="{{ $id }}" {{ (in_array($id, old('sub_categories', [])) || $addVoucher->sub_categories->contains($id)) ? 'selected' : '' }}>{{ $sub_category }}</option>
                                @endforeach
                            </select>
