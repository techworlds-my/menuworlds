    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.item-managements.update", [$itemManagement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.itemManagement.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $itemManagement->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $itemManagement->price) }}" step="0.01" required>
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sales_price" id="sales_price" value="{{ old('sales_price', $itemManagement->sales_price) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_recommended" id="is_recommended" value="1" {{ $itemManagement->is_recommended || old('is_recommended', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_popular" id="is_popular" value="1" {{ $itemManagement->is_popular || old('is_popular', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_new" id="is_new" value="1" {{ $itemManagement->is_new || old('is_new', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="rate" id="rate" value="{{ old('rate', $itemManagement->rate) }}" step="1">
                            @if($errors->has('rate'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rate') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $itemManagement->is_active || old('is_active', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_veg" id="is_veg" value="1" {{ $itemManagement->is_veg || old('is_veg', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_halal" id="is_halal" value="1" {{ $itemManagement->is_halal || old('is_halal', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="sub_category_id" id="sub_category_id">
                                @foreach($sub_categories as $id => $sub_category)
                                    <option value="{{ $id }}" {{ (old('sub_category_id') ? old('sub_category_id') : $itemManagement->sub_category->id ?? '') == $id ? 'selected' : '' }}>{{ $sub_category }}</option>
                                @endforeach
                            </select>
