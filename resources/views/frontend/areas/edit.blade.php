                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.areas.update", [$area->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="area" id="area" value="{{ old('area', $area->area) }}" required>
                            @if($errors->has('area'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="postcode" id="postcode" value="{{ old('postcode', $area->postcode) }}" step="1" required>
