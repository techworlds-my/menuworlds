    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.merchant-managements.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ssm" id="ssm" value="{{ old('ssm', '') }}">
                            @if($errors->has('ssm'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ssm') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="in_charge_person" id="in_charge_person" value="{{ old('in_charge_person', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="merchant" id="merchant" value="{{ old('merchant', '') }}">
