    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.merchant-levels.update", [$merchantLevel->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="level">{{ trans('cruds.merchantLevel.fields.level') }}</label>
                            <input class="form-control" type="text" name="level" id="level" value="{{ old('level', $merchantLevel->level) }}" required>
                            @if($errors->has('level'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_enable" id="in_enable" value="1" {{ $merchantLevel->in_enable || old('in_enable', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="description" id="description" value="{{ old('description', $merchantLevel->description) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="module" id="module" value="{{ old('module', $merchantLevel->module) }}">
