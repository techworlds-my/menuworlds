    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seats.update", [$seat->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <div>
                                <input type="hidden" name="used" value="0">
                                <input type="checkbox" name="used" id="used" value="1" {{ $seat->used || old('used', 0) === 1 ? 'checked' : '' }}>
                                <label for="used">{{ trans('cruds.seat.fields.used') }}</label>
                            </div>
                            @if($errors->has('used'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_start" id="time_start" value="{{ old('time_start', $seat->time_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_end" id="time_end" value="{{ old('time_end', $seat->time_end) }}">
