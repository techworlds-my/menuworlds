                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.order-items.update", [$orderItem->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $orderItem->price) }}" step="0.01">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="add_on" id="add_on" value="{{ old('add_on', $orderItem->add_on) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="add_on_price" id="add_on_price" value="{{ old('add_on_price', $orderItem->add_on_price) }}" step="0.01">
