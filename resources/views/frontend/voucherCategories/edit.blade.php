    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.voucher-categories.update", [$voucherCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="category">{{ trans('cruds.voucherCategory.fields.category') }}</label>
                            <input class="form-control" type="text" name="category" id="category" value="{{ old('category', $voucherCategory->category) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_enable" id="is_enable" value="1" {{ $voucherCategory->is_enable || old('is_enable', 0) === 1 ? 'checked' : '' }}>
