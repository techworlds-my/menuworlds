    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.asdasds.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="adasda">{{ trans('cruds.asdasd.fields.adasda') }}</label>
                            <input class="form-control" type="text" name="adasda" id="adasda" value="{{ old('adasda', '') }}">
