    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.voucher-reedems.update", [$voucherReedem->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="redeem_date" id="redeem_date" value="{{ old('redeem_date', $voucherReedem->redeem_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $voucherReedem->amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type" id="type" value="{{ old('type', $voucherReedem->type) }}">
                            @if($errors->has('type'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('type') }}
                                </div>
