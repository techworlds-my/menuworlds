    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seats-logs.update", [$seatsLog->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="seats" id="seats" value="{{ old('seats', $seatsLog->seats) }}" step="1">
                            @if($errors->has('seats'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('seats') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_start" id="time_start" value="{{ old('time_start', $seatsLog->time_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_end" id="time_end" value="{{ old('time_end', $seatsLog->time_end) }}">
