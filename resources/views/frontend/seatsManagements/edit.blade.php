    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.seats-managements.update", [$seatsManagement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <div>
                                <input type="hidden" name="used" value="0">
                                <input type="checkbox" name="used" id="used" value="1" {{ $seatsManagement->used || old('used', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_start" id="time_start" value="{{ old('time_start', $seatsManagement->time_start) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_end" id="time_end" value="{{ old('time_end', $seatsManagement->time_end) }}">
