    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.item-sub-categories.update", [$itemSubCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title">{{ trans('cruds.itemSubCategory.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $itemSubCategory->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_enable" id="is_enable" value="1" {{ $itemSubCategory->is_enable || old('is_enable', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="parent" id="parent" value="{{ old('parent', $itemSubCategory->parent) }}">
