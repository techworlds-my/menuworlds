        ...
        <div class="col-md-12">
            @can('item_sub_category_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.item-sub-categories.create') }}">
...
>>>>>>> 2c4a47a5c3e5d5ea4cf11bf66ce3c586c4dbcc8f
                                            ...
                                            @can('item_sub_category_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.item-sub-categories.edit', $itemSubCategory->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('item_sub_category_delete')
                                                <form action="{{ route('frontend.item-sub-categories.destroy', $itemSubCategory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('item_sub_category_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.item-sub-categories.massDestroy') }}",
