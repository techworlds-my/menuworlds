    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.order-managements.update", [$orderManagement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="order">{{ trans('cruds.orderManagement.fields.order') }}</label>
                            <input class="form-control" type="text" name="order" id="order" value="{{ old('order', $orderManagement->order) }}" required>
                            @if($errors->has('order'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="username" id="username" value="{{ old('username', $orderManagement->username) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $orderManagement->address) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $orderManagement->price) }}" step="0.01" required>
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="delivery_charge" id="delivery_charge" value="{{ old('delivery_charge', $orderManagement->delivery_charge) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tax" id="tax" value="{{ old('tax', $orderManagement->tax) }}" step="0.01">
                            @if($errors->has('tax'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tax') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total" id="total" value="{{ old('total', $orderManagement->total) }}" step="0.01" required>
                            @if($errors->has('total'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('total') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comment" id="comment" value="{{ old('comment', $orderManagement->comment) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="voucher_used" id="voucher_used" value="1" {{ $orderManagement->voucher_used || old('voucher_used', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="time_needed" id="time_needed" value="{{ old('time_needed', $orderManagement->time_needed) }}">
